...
kubernetes v1.29 已经发布了!!! 但 Kind 还没有提供对应的版本,因此我首先构建了一个对应版本: 

`ghcr.io/liangyuanpeng/kindest/node:v1.29.0` 欢迎试用!
...
我也做过这样的尝试,但是当我想将这个镜像导入到 containerd 的时候发现会失败,没有权限.
